  ...
  return (
    <section className="relative bg-brand-primary px-10 pt-20 pb-28 overflow-hidden text-center max-[640px]:px-6 max-[640px]:pt-16 max-[640px]:pb-24">
      ...
      <div className="relative z-[1]">
        ...
        <div className="animate-about-fade-1 inline-flex items-center gap-2 px-4 py-[6px] bg-brand-amber/12 border border-brand-amber/30 rounded-full font-jakarta text-[0.72rem] font-bold text-brand-amber tracking-[0.08em] uppercase mb-6">
        ...
        <p className="animate-about-fade-3 font-jakarta text-[clamp(0.95rem,1.5vw,1.1rem)] text-white/60 max-w-[32rem] mx-auto leading-[1.75] mb-8">
